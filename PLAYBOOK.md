...
- **Outcome:** A unique QR code is generated for that vendor and synced to the cloud.
- **Next Step:** Print the QR code or share the PDF with the Vendor to stick on their tanker.
- **Important Note:** Security Guards do not have the permission to create vendors or generate QR codes. They can only read the QR codes generated by the Admins.
